...
# load_dotenv(verbose=True)  # This will show more info about loading
load_dotenv()

# print("Environment variables after loading:")
# for var in ['AWS_COGNITO_DOMAIN', 'AWS_COGNITO_APP_CLIENT_ID', 'AWS_COGNITO_APP_CLIENT_SECRET', 'GRAPHQL_ENDPOINT']:
