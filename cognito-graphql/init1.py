...
if __name__ == "__main__":
    ...
    client = CognitoGraphQLClient(
        cognito_domain="https://ap-southeast-2e4ufifd2s.auth.ap-southeast-2.amazoncognito.com",
        client_id="7jse8bvvjc968v3si04k6d6ejl",
        client_secret="m85sdobr9nu7k3olsm3hbdij8g3mm42o7gld7ntoe4c8igce159",
        graphql_endpoint="http://localhost:3280/graphql"
    )
    ...
    try:
        ...
        # Keep the program running to demonstrate token refresh
        print("Client running with automatic token refresh. Press Ctrl+C to exit.")
        while True:
            time.sleep(10)
